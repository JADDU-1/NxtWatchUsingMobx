...
export const networkCallWithoutApisauce = async (
  api: any,
  url: string,
  requestObject: any,
...
export const getFormattedErrorDescription = (error: any) => {
  const formattedError = getFormattedError(error);
  return formattedError.description;
};

export function isNetworkErrorOrTimedOutError(error: any) {
...
export const getFormattedError = (apiError: any) => {
